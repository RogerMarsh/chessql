# test_filters_comparison.py
# Copyright 2025 Roger Marsh
# Licence: See LICENCE (BSD licence)

"""Verify chessql.core.parser output for comparison filters.

The '==', '>', '>=', '<', '<=', '!=' or '≠', '[<]' or '≺', and '[>]' or '≻',
filters' tests are in this module.
...
class FiltersComparision(verify.Verify):
    ...
    def test_166_descendant_eq_ascii_04_set_03_numeric(self):
        self.verify("a[>=]1", [], returncode=1)
...
if __name__ == "__main__":
    if verify.is_cql_on_path():
        ...
        runner().run(loader(FiltersComparision))
