...
class PieceDesignator(unittest.TestCase):
    ...
    def test_01_PIECE_DESIGNATOR(self):
        ae = self.assertEqual
        ae(piecedesignator.PieceDesignator.PIECE_DESIGNATOR,
           r''.join(
    ...
    def test_02_piece_designator(self):
        ae = self.assertEqual
        ae(isinstance(piecedesignator.PieceDesignator.piece_designator,
                      re.Pattern),
           True)
    ...
    def test_04_PieceDesignator(self):
        ...
        ae(len([a for a in dir(piecedesignator.PieceDesignator.PieceDesignator)
                if not a.startswith('_')]) - 2,
           14)
