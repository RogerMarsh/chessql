...
class_from_token_name = {
    ...
    "black": filters.Black,
    "block_comment": filters.BlockComment,
    "brace_left": filters.brace_left,
    "brace_right": filters.brace_right,
    "bracket_left": filters.bracket_left,
    "bracket_right": filters.bracket_right,
    "cql": cql.CQL,
    "capture": filters.Capture,
    "captures": filters.Captures,
    "captures_l": filters.CapturesL,
    "captures_lpe": filters.CapturesL,
    "captures_pb": filters.Captures,
    "captures_pe": filters.Captures,
    "captures_pbpe": filters.Captures,
    "captures_lr": filters.CapturesLR,
    "captures_pbr": filters.CapturesR,
    ...
    "end_of_line": filters.end_of_line,
    "end_of_stream": filters.end_of_stream,
    "eq": filters.Eq,
    "event": filters.Event,
    ...
    "light": filters.Light,
    "line": filters.Line,
    "line_comment": filters.line_comment,
    "local": filters.Local,
    "loop": filters.Loop,
    ...
    "regex_repeat": filters.RegexRepeat,
    ...
    "single_move_lpe": filters.SingleMoveL,
    "single_move_pb": filters.SingleMove,
    "single_move_pe": filters.SingleMove,
    "single_move_pbpe": filters.SingleMove,
    "single_move_lr": filters.SingleMoveLR,
    "single_move_pbr": filters.SingleMoveR,
